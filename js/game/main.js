...
function create()
{
    ...
    menuLabel = game.add.text(0, 0, 'PAUSE', { font: '18px Arial', fill: '#FFFFFF' });
    menuLabel.inputEnabled = true;
    menuLabel.events.onInputUp.add(PauseGame, self);
...
{
    menuLabel.text = "PAUSE"
    game.paused = false;
}

function PauseGame()
{
    menuLabel.text = "PAUSED"
    game.paused = true;
}